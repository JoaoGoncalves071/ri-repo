...
\begin{table}[h!]
    ...
    \hline
        2 & Servidores & 192.168.52.63 & 192.168.52.0/26 & Server1\\
        3 & Engenharia & 192.168.53.63 & 192.168.53.0/26 & PC1, PC2\\
    \hline
    \end{tabular}
...
\begin{table}[h!]
    ...
    \hline
        2 & Server1 & 192.168.52.1/26 & 192.168.52.63\\
        3 & PC1 & 192.168.53.1/26 & 192.168.53.63\\
        3 & PC2 & 192.168.53.2/26 & 192.168.53.63\\
    \hline
    \end{tabular}
...
A escolha da Empresa B em utilizar endereços IPv4 privados com máscara /26 para suas VLANs é uma boa decisão. Os endereços ipv4 públicos são limitados, e a utilização de endereços privados permite a criação de redes locais sem a necessidade de endereços públicos.
A máscara /26 permite a criação de 4 sub-redes, cada uma com 62 endereços disponíveis, o que é suficiente para a quantidade de dispositivos que a empresa tem em cada VLAN. Além disso, o uso de endereços IPv4 privados é uma prática comum em redes locais, pois permite a segmentação da rede e a utilização de endereços públicos apenas nos dispositivos que necessitam de comunicação com a Internet. Assim, a utilização de endereços IPv4 privados com máscara /26 é uma decisão acertada e necessária para a Empresa B.
