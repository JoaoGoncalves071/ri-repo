...
Nesta tarefa, o objetivo é configurar o OSPF na Área 2 e estabelecer RIP em especificas interfaces para conectar a Área 2 ao backbone (Area 0).
...
Para o router 9, as configurações foram realizadas com sucesso, como se pode observar na figura \ref{fig:config30}:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{imagens/Tarefa4/17.config_R9.png}
  \caption{Configuração do OSPF no Router 9.}
  \label{fig:config30}
\end{figure}
\vspace{0.2cm}


Para o router 8, as configurações foram realizadas com sucesso, como se pode observar na figura \ref{fig:config31}:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{imagens/Tarefa4/18.config_R8.png}
