...
\begin{itemize}
  ...
  \item \textbf{trace <destination-ip> }: Permite monitorizar o caminho de um pacote para o destino, mostrando os routers intermediários que o pacote atravessa. Tal como se pode observar na figura \ref{fig:config43}.
  \vspace{0.2cm}
  ...
  \item \textbf{show ip ospf interface}: Mostra informações detalhadas sobre as interfaces OSPF, incluindo custos e estados. Tal como se pode observar na figura \ref{fig:config44}.
  \vspace{0.2cm}
